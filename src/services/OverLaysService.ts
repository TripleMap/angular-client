...
@Injectable() export class OverLaysService {
    ...
    constructor(public _selectedFeatureService: SelectedFeatureService, public _http: HttpClient) {
    ...
    subscribeLayerClick = (feature) => this._selectedFeatureService.updateFeatureForInfo(feature)
    ...
    addLayerToMap() {
        ...
        let self = this;
        TDMap.Utils.Promise = {
            getPromise: function (url, params, headers) {
                var request = {
                    url: url,
                    type: 'GET',
                };
                ...
                return new Promise(function(resolve, reject){
                    try {
                          self._http.get(url, {params}).subscribe(data => resolve({data}));
                    }
                });
            }
        };
